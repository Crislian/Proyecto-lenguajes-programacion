...
JavaVisitor.prototype.visitTypeTypeOrVoid = function(ctx) {
  return this.visitChildren(ctx);
};
...
JavaVisitor.prototype.visitIntegerLiteral = function(ctx) {
  return this.visitChildren(ctx);
};


// Visit a parse tree produced by JavaParser#floatLiteral.
JavaVisitor.prototype.visitFloatLiteral = function(ctx) {
  return this.visitChildren(ctx);
};
...
JavaVisitor.prototype.visitLocalTypeDeclaration = function(ctx) {
  return this.visitChildren(ctx);
};
